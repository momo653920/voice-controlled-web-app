...
export const signInUser = (email, password, setLoading, setError, setSuccessMessage) => (dispatch) => {
  setLoading(true);
  fire
    .auth()
...
export const signUpUser = (name, email, password, setLoading, setError, setSuccessMessage) => (dispatch) => {
  setLoading(true);
  fire
    .auth()
